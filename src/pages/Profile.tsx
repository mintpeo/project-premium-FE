          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden py-1">
            <div className="p-6 pb-5 flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-[#0d6efd] font-bold text-[17px]">{profile.fullName || 'User'}</span>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-gray-100 pb-8 mb-8">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-bold text-[#1e293b] text-[15px]">{profile.fullName || '—'}</span>
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-bold text-[#1e293b] text-[15px]">{profile.phoneNumber || '—'}</span>
                </div>
                <div className="flex flex-col gap-1">
          ...
          {activeTab === 'edit' && (
            <>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-5 max-w-md">
                ...
                <div>
                  <label className="block text-[14px] font-medium text-gray-700 mb-2">Số điện thoại</label>
                  <input
                    type="tel"
