...
const Checkout = () => {
  ...
  // Lấy sản phẩm từ state khi bấm "Mua Ngay"
    ...
    return (
      <div className="min-h-screen flex flex-col bg-[#F0F4FF] font-sans">
        ...
        <main className="flex-1 flex flex-col items-center justify-center gap-4">
          <p className="text-gray-600 text-lg">Không có sản phẩm nào để thanh toán.</p>
          <button
            onClick={() => navigate('/')}
          ...
          <div className="w-full lg:w-[400px]">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-6">
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className="text-sm font-bold text-gray-800">{product.price?.toLocaleString('vi-VN')}đ</span>
                  </div>
                </div>
              </div>
              ...
              <p className="text-center text-xs text-gray-500 mt-4">
                Bằng việc đặt hàng, bạn đồng ý với <a href="#" className="text-blue-500 hover:underline">Điều khoản dịch vụ</a>
              </p>
            </div>
          </div>
        </div>
