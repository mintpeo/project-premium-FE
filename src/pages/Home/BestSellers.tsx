...
const products = [
  {
    id: 1,
    title: 'Nâng cấp tài khoản Canva 12 tháng',
  ...
  {
    id: 2,
    title: 'Nâng cấp Youtube Premium chính chủ',
    category: 'GIẢI TRÍ',
    sales: 9535,
    price: '359,000đ',
    originalPrice: null,
  ...
  {
    id: 3,
    title: 'Tài khoản Google AI - Trợ lý thông...',
    category: 'AI',
    sales: 4295,
    price: '449,000đ',
    originalPrice: null,
    discount: null,
    image: 'https://picsum.photos/seed/googleai/200/200'
  },
  {
    id: 4,
    title: 'Nâng cấp bộ nhớ Google One chính...',
    category: 'LÀM VIỆC',
    sales: 7701,
    price: '149,000đ',
    originalPrice: null,
    discount: '-79%',
    image: 'https://picsum.photos/seed/drive/200/200'
  },
  {
    id: 5,
    title: 'Tài khoản Capcut Pro | Thiết kế vide...',
    category: 'LÀM VIỆC',
    sales: 3899,
    price: '79,000đ',
    originalPrice: null,
    discount: null,
    image: 'https://picsum.photos/seed/capcut/200/200'
  },
  {
    id: 6,
    title: 'Nâng cấp Microsoft 365...',
    category: 'KHÁC',
    sales: 2124,
    price: '299,000đ',
  ...
  {
    id: 7,
    title: 'Tài khoản Disney Plus 01 User',
    category: 'KHÁC',
    sales: 2217,
    price: '399,000đ',
    originalPrice: null,
